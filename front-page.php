...
<!-- ================================================
     2. TRUST BAR
     ================================================ -->
<section class="trust-bar" aria-label="Customer reviews and credentials">
    <div class="container">

        <div class="trust-bar__item">
            <span class="trust-bar__badge-icon" aria-hidden="true">
                <svg class="trust-bar__google-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="trust-bar__stat">
                <div class="trust-bar__stars" aria-label="4.9 out of 5 stars">
                    <svg viewBox="0 0 20 20" aria-hidden="true"><path d="M10 1l2.39 4.84 5.34.78-3.86 3.76.91 5.32L10 13.27l-4.78 2.43.91-5.32L2.27 6.62l5.34-.78z" fill="#FBBC05"/></svg>
                    <svg viewBox="0 0 20 20" aria-hidden="true"><path d="M10 1l2.39 4.84 5.34.78-3.86 3.76.91 5.32L10 13.27l-4.78 2.43.91-5.32L2.27 6.62l5.34-.78z" fill="#FBBC05"/></svg>
                    <svg viewBox="0 0 20 20" aria-hidden="true"><path d="M10 1l2.39 4.84 5.34.78-3.86 3.76.91 5.32L10 13.27l-4.78 2.43.91-5.32L2.27 6.62l5.34-.78z" fill="#FBBC05"/></svg>
                    <svg viewBox="0 0 20 20" aria-hidden="true"><path d="M10 1l2.39 4.84 5.34.78-3.86 3.76.91 5.32L10 13.27l-4.78 2.43.91-5.32L2.27 6.62l5.34-.78z" fill="#FBBC05"/></svg>
                    <svg viewBox="0 0 20 20" aria-hidden="true"><path d="M10 1l2.39 4.84 5.34.78-3.86 3.76.91 5.32L10 13.27l-4.78 2.43.91-5.32L2.27 6.62l5.34-.78z" fill="#FBBC05"/></svg>
                </div>
                <span class="trust-bar__reviews">7,000+ Five-Star Reviews</span>
            </div>
        </div>
        ...
        <div class="trust-bar__item">
            <span class="trust-bar__badge-icon" aria-hidden="true">
                <svg viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M11 2L13.5 7.5H19.5L14.8 11.2L16.8 17L11 13.5L5.2 17L7.2 11.2L2.5 7.5H8.5L11 2Z" fill="rgba(255,255,255,0.12)" stroke="rgba(255,255,255,0.55)" stroke-width="1.5" stroke-linejoin="round"/>
                    <polyline points="7,11 10,14 15,8" stroke="#ffffff" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" fill="none"/>
                </svg>
            </span>
            <div class="trust-bar__stat">
                <span class="trust-bar__stat-value">Licensed &amp; Insured</span>
                <span class="trust-bar__stat-label">In All Service States</span>
            </div>
        </div>
        ...
        <div class="trust-bar__item">
            <span class="trust-bar__badge-icon" aria-hidden="true">
                <svg viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="11" cy="11" r="8.5" stroke="rgba(255,255,255,0.5)" stroke-width="1.5" fill="rgba(255,255,255,0.1)"/>
                    <polyline points="7,11 10,14 15,8" stroke="#ffffff" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </span>
            <div class="trust-bar__stat">
                <span class="trust-bar__stat-value">Satisfaction Guarantee</span>
                <span class="trust-bar__stat-label">We Come Back Free</span>
            </div>
        </div>
            ...
            <a href="<?php echo esc_url( home_url( '/services/pest-control' ) ); ?>" class="service-card">
                <div class="service-card__icon" aria-hidden="true">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <path d="M10.5 4.5L8.5 2.5M13.5 4.5L15.5 2.5"/>
                        <path d="M9.5 11L6 10M9.5 12.5L6 12.5M9.5 14L6 15.5"/>
            ...
            <a href="<?php echo esc_url( home_url( '/services/rodent-control' ) ); ?>" class="service-card">
                <div class="service-card__icon" aria-hidden="true">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <circle cx="18.5" cy="11" r="0.9" fill="currentColor" stroke="none"/>
                        <path d="M3 18Q1 21 3 23"/>
                    </svg>
                </div>
            ...
            <a href="<?php echo esc_url( home_url( '/services/mosquito-control' ) ); ?>" class="service-card">
                <div class="service-card__icon" aria-hidden="true">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <path d="M12 5.5V3"/>
                        <path d="M10.5 10.5Q8 9 5.5 11.5"/>
                        <path d="M13.5 10.5Q16 9 18.5 11.5"/>
                        <path d="M10.5 15.5L7 18.5M13.5 15.5L17 18.5"/>
                    </svg>
                </div>
            ...
            <a href="<?php echo esc_url( home_url( '/services/bed-bugs' ) ); ?>" class="service-card">
                <div class="service-card__icon" aria-hidden="true">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                        ...
                        <path d="M10.5 7L8.5 5M13.5 7L15.5 5"/>
                        <path d="M6.5 12L4 10.5M6.5 13.5L4 13.5M6.5 15L4 16.5"/>
